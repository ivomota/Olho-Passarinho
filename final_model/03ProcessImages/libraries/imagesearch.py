...
class Indexer(object):
    ...
    def add_to_index(self,imname,descr):
        ...
        #normalize histogram using tf-idf
        for j, freq_word in enumerate(imwords):
            imwords[j] = (freq_word / nbr_words) * self.voc.idf[j]
            # print "freq word " +str(j)+ " = " + str(freq_word)
            # print "idf word " +str(j)+ " = " + str(self.voc.idf[j])
            # print "tf-idf word " +str(j)+ " = " + str(imwords[j])
